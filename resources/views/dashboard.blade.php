            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="mb-6">
                    ...
                    <form method="POST" action="#">
                        @csrf
                        <div class="grid grid-colds-1 md:grid-cols-2 gap-4">
                            <div>
                        ...
                        <div class="mt-4">
                            ...
                            text-white font-bold py-2 px-4 rounded">Add Student</button>
                        </div>
                    </form>
                </div>
                    ...
                    <table class="min-w-full bg-white border">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="py-2 border-b px-14">jandu@gmail.com</td>
                                <td class="py-2 border-b px-14">12345678901</td>
                                <td class="py-2 border-b px-14">Culassi Highways</td>
